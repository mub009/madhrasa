                ...
                <div class="form-body">
                        ...
                        <div class="col-md-6">
                            <div class="form-group" id="validation_RegNo_insert">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" name="RegNo" value="<?=$HouseDetails['RegNo']?>" id="RegNo" placeholder="രെജിസ്ട്രേഷൻ നമ്പർ"
                                        autocomplete="off">
                                </div>
                            ...
                            <div class="form-group" id="validation_Name_insert">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="Name" name="Name"
                                        placeholder="കുടുംബ നാഥന്റെ പേര് " value="<?=$HouseDetails['Name']?>" autocomplete="off">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group" id="validation_Address_insert">
                                <label class="control-label col-md-6" style=" text-align:left;">അഡ്രസ്സ്<span
                                        class="required" aria-required="true"> * </span> </label>
                                <div class="col-md-6 ">
                                    <textarea class="form-control" id="Address" name="Address" rows="3"><?=$HouseDetails['Address']?></textarea>
                            ...
                            <div class="form-group" id="validation_WardNo_insert">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="WardNo" name="WardNo"
                                        placeholder="വാർഡ് നമ്പർ " value="<?=$HouseDetails['WardNo']?>" autocomplete="off">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group" id="validation_HouseNo_insert">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="HouseNo" name="HouseNo"
                                        placeholder="വീട് നമ്പർ" autocomplete="off" value="<?=$HouseDetails['HouseNo']?>">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group" id="validation_MobNo_insert">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="MobNo" name="MobNo"
                                        placeholder="മൊബൈൽ നമ്പർ" autocomplete="off" value="<?=$HouseDetails['MobNo']?>">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-group" id="validation_WhatsappNo_insert">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="WhatsappNo" name="WhatsappNo"
                                        placeholder="വാട്സ്ആപ്പ് നമ്പർ" autocomplete="off" value="<?=$HouseDetails['WhatsappNo']?>">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group" id="validation_Occupation_insert">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" name="Occupation" id="Occupation"
                                        placeholder="കുടുംബ നാഥന്റെ തൊഴിൽ" autocomplete="off" value="<?=$HouseDetails['Occupation']?>">
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group" id="validation_NoOfmembers_insert">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" name="NoOfmembers" id="NoOfmembers" placeholder="കുടുംബത്തിന്റെ അംഗസംഖ്യ" autocomplete="off" value="<?=$HouseDetails['NoOfMembers']?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                                ...
                                <div class="col-md-6 ">
                                    ...
                                    <div class="mt-radio-inline">
                                        ...
                                        <input type="radio" name="IsStudy"
                                            onclick="madrasaqualificationcheck(this.value)" value="0" <?=($HouseDetails['is_Study']!=1)?'checked':''?>/>ഇല്ല

                                        <input type="radio" name="IsStudy"
                                            onclick="madrasaqualificationcheck(this.value)" id='madrasaqualification'
                                            value="1" <?=($HouseDetails['is_Study']==1)?'checked':''?>/> ഉണ്ട്
                            ...
                            <div id="madrasaqualificationform" style="display:<?=($HouseDetails['is_Study']==1)?'':'none'?>">
                                <div class="form-group" id="">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control" name="NoOfStudents" id="NoOfStudents"
                                            placeholder="എത്ര ആളുകൾ " autocomplete="off" value="<?=$HouseDetails['NoTotalStudyStudents']?>">
                                    </div>
                                </div>
                                <div class="form-group" id="">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control" name="MaleStudent" id="MaleStudent"
                                            placeholder="ആൺ എത്ര " autocomplete="off" value="<?=$HouseDetails['NoStudyBoys']?>">
                                    </div>
                                </div>
                                <div class="form-group" id="">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control" name="FemaleStudent" id="FemaleStudent"
                                            placeholder="പെൺ  എത്ര " autocomplete="off" value="<?=$HouseDetails['NoStudyGirls']?>">
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                                ...
                                <div class="col-md-6 ">
                                    ...
                                    <div class="mt-radio-inline">
                                        ...
                                        <input type="radio" name="IsAdmision" onclick="personcheck(this.value)"
                                            value="0" <?=($HouseDetails['is_AdmisionNextYear']!=1)?'checked':''?>/>ഇല്ല

                                        <input type="radio" name="IsAdmision" onclick="personcheck(this.value)"
                                            id='madrasaqualification' value="1" <?=($HouseDetails['is_AdmisionNextYear']==1)?'checked':''?>/> ഉണ്ട്
                            ...
                            <div id="personcheck" style="display:<?=($HouseDetails['is_AdmisionNextYear']==1)?'':'none'?>">
                                <div class="form-group" id="">
                                    <label class="control-label col-md-6" style=" text-align:left;">എത്ര ആളുകൾ ?<span
                                            class="required" aria-required="true"> * </span></label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control" name="NoOfAdmision" id="NoOfAdmision"
                                            placeholder="എത്ര ആളുകൾ " autocomplete="off" value="<?=$HouseDetails['NoTotalAdmisionNextYearStudents']?>">
                                    </div>
                                </div>
                                <div class="form-group" id="">
                                    <label class="control-label col-md-6" style=" text-align:left;">ആൺ എത്ര ? <span
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control" name="MaleAdmision" id="MaleAdmision"
                                            placeholder="ആൺ എത്ര " autocomplete="off" value="<?=$HouseDetails['NoAdmisionNextYearBoys']?>">
                                    </div>
                                </div>
                                <div class="form-group" id="">
                                    <label class="control-label col-md-6" style=" text-align:left;">പെൺ എത്ര ?<span
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control" name="FemaleAdmision" id="FemaleAdmision"
                                            placeholder="പെൺ  എത്ര " autocomplete="off" value="<?=$HouseDetails['NoAdmisionNextYearGirls']?>">
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6">
                                ...
                                <div class="col-md-6 ">
                                    ...
                                    <div class="mt-radio-inline">
                                        ...
                                        <input type="radio" name="IsOldstundents" onclick="oldstudentscheck(this.value)"
                                            value="0" <?=($HouseDetails['is_PriviousStudent']!=1)?'checked':''?>/>ഇല്ല

                                        <input type="radio" name="IsOldstundents" onclick="oldstudentscheck(this.value)"
                                            id='madrasaqualification' value="1" <?=($HouseDetails['is_PriviousStudent']==1)?'checked':''?> /> ഉണ്ട്
                            ...
                            <div id="oldstudentscheck" style="display:<?=($HouseDetails['is_PriviousStudent']==1)?'':'none'?>">
                                <div class="form-group" id="">
                                    <label class="control-label col-md-6" style=" text-align:left;">എത്ര ആളുകൾ ?<span
                                            class="required" aria-required="true"> * </span></label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control" name="NoOfOldStudents" id="NoOfOldStudents"
                                            placeholder="എത്ര ആളുകൾ " autocomplete="off" value="<?=$HouseDetails['NoTotalPriviousStudent']?>">
                                    </div>
                                </div>
                                <div class="form-group" id="">
                                    <label class="control-label col-md-6" style=" text-align:left;">ആൺ എത്ര ? <span
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control" name="MaleOldStudent" id="MaleOldStudent"
                                            placeholder="ആൺ എത്ര " autocomplete="off" value="<?=$HouseDetails['NoTotalPriviousBoyStudent']?>">
                                    </div>
                                </div>
                                <div class="form-group" id="">
                                    <label class="control-label col-md-6" style=" text-align:left;">പെൺ എത്ര ?<span
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control" name="FemaleOldStudent"
                                            id="FemaleMaleOldStudent" placeholder="പെൺ  എത്ര " autocomplete="off" value="<?=$HouseDetails['NoTotalPriviousGirlStudent']?>">
                        ...
                        <div class="col-md-6">
                            <div class="form-group" id="validation_Feedback_insert">
                                <label class="control-label col-md-6" style=" text-align:left;">അഭിപ്രായം<span
                                        class="required" aria-required="true"> * </span> </label>
                                <div class="col-md-6 ">
                                    <textarea class="form-control" id="Feedback" name="Feedback" rows="3" ><?=$HouseDetails['Feedback']?></textarea>
                    ...
                    <input type="hidden" name="Id" value="<?=$HouseDetails['Id']?>">
...
var flag;
    $("#insert").click(function (e) {
        ...
        $.ajax({
            url: base_url + 'backend/madhrasa/house/house/update',
            type: 'POST',
            dataType: "json",
            async: false,
